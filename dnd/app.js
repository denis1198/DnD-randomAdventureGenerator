...
function justBbegBack() {
  removeOldAdventure();
  randomBbegBackground();
}
function justStartingPoint() {
  removeOldAdventure();
  randomStartingPlace();
}
function justHistory() {
  removeOldAdventure();
  randomStoryIdeas();
}
function justSideQuest() {
  removeOldAdventure();
  randomSideQuestsIdeas();
}
function justEnemies() {
  removeOldAdventure();
  randomCommonEnemiesGenerator();
}
function justMundaneDrops() {
  removeOldAdventure();
  randomMundaneDropsGenerator();
}
function justCommonDrops() {
  removeOldAdventure();
  randomCommonDropsGenerator();
}
function justUncommonDrops() {
  removeOldAdventure();
  randomUncommonDropsGenerator();
}
function justRareDrops() {
  removeOldAdventure();
  randomRareDropsGenerator();
}
function justVeryRareDrops() {
  removeOldAdventure();
  randomveryRareDropsGenerator();
}
function justLegendaryDrops() {
  removeOldAdventure();
  randomLegendaryDropsGenerator();
}
